...
10. 注释与可读性遵循 [docs/comment-style.md](docs/comment-style.md)：解释意图而非翻译代码；新 API 首次出现按「API 名：作用」格式说明；测试文件头用 JSDoc 注明主题与跑法；中文为主、术语保留英文。范本：`tests/01-basics/01-structure-demo.spec.ts`。
